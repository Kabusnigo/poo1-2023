 ...
 * resultado de poner una a continuación de la otra. por ejemplo si q1 = [1,2,3]
 * (con 1 al frente y 3 al final) y q2 = [5,7], el resultado es [1,2,3,5,7] (con
 * 1 al frente y 7 al final).
 */
